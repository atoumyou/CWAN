function res = run_CWAN_Lightness(net, x, dzdy, res, varargin)
        ...
        case 'conv'
            ...
            switch i
                ...
                case 11
                    if gpuMode == 0
                        temp=(res(i+1).x);
                        temp= temp + (res(8).x) + (res(10).x) + (res(2).x)  ;
                        res(i+1).x=single(temp);
                    else
                        temp=(res(i+1).x);
                        temp= temp + (res(8).x) + (res(10).x) + (res(2).x)  ;
                ...
                case 17
                    if gpuMode == 0
                        temp=(res(i+1).x);
                        temp= temp + (res(16).x) + (res(14).x) + (res(8).x) + (res(2).x)  ;
                        res(i+1).x=single(temp);
                    else
                        temp=(res(i+1).x);
                        temp= temp + (res(16).x) + (res(14).x) + (res(8).x) + (res(2).x)  ;
